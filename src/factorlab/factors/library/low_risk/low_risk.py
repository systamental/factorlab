...
class LowRisk(Factor):
    ...
    **kwargs:
    ...
    def __init__(self,
                 method: str = 'beta',
                 **kwargs):
        super().__init__(name='LowRisk',
                         description='A factory for various low risk factors.',
                         category='LowRisk')
        self.method = method
        self.kwargs = kwargs
    ...
    def fit(self, X: Union[pd.Series, pd.DataFrame], y: Optional[Union[pd.Series, pd.DataFrame]] = None) -> 'LowRisk':
        """
